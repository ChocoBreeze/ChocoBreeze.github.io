...
- 글 상세에는 제목·사이트명·발행일·canonical URL을 Markdown 인용 형식으로 복사하는 액션이 있습니다.
...
6. [완료] 제목·사이트명·발행일·canonical URL 기반 Markdown 인용 텍스트 복사를 추가했습니다.
...
- 인용문에 제목·사이트명·발행일·URL이 포함되고, 날짜가 없는 레거시 글도 복사 가능한지 확인
