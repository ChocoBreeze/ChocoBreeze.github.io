...
| 16 | [시리즈·관련 글·학습 경로](16-series-related-learning-paths.md) | 부분 완료(학습 경로 보류) | P2 | 없음 | 대 |
...
- 16번: `prerequisiteSlugs`를 활용한 학습 경로 UI
...
12~15, 18, 20, 22, 24번의 기능 구현은 완료되었습니다. 15번의 인용 텍스트 복사와 16·17·19·21번의 잔여 항목은 별도 작업으로 관리합니다.
