...
<strong>상세 동작 과정</strong>:

1. <strong>초기 정렬</strong>:
   ```cpp
   vector<int> sortedGifts = gifts;
   sort(sortedGifts.begin(), sortedGifts.end());
   ```
