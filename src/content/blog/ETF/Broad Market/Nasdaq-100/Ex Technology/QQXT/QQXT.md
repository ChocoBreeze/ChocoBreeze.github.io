...
## 개요
QQXT는 NASDAQ-100 지수에서 기술(Technology) 섹터를 제외한 나머지 종목들로 구성된 ETF로, 기술주 집중 리스크를 피하면서 나스닥 100 기업의 비기술 분야에 투자하고자 하는 투자자를 위해 설계되었다. Equal-weighted(동일가중) 방식으로 구성되어 대형 기술주 편중을 근본적으로 차단한다. Morningstar는 이 펀드에 대해 **Neutral** 등급을 부여하고 있으며, Large Blend 카테고리로 분류한다.[1][2][3]

## ETF 분류

| 항목 | 내용 |
|------|------|
| **최종 폴더** | `ETF/Broad Market/Nasdaq-100/Ex Technology/QQXT` |
| **대분류** | 대표지수 |
| **하위 분류** | Nasdaq-100 / Ex Technology / Equal Weight |
| **핵심 전략** | Nasdaq-100 구성 종목 중 기술 섹터를 제외한 비기술 종목에 동일가중으로 투자 |
| **운용 방식** | 패시브 |
| **레버리지·인버스 여부** | 아니오 |
| **옵션 인컴 전략 여부** | 아니오 |
| **분류 판단** | 특정 기술 테마 ETF가 아니라 Nasdaq-100에서 기술 섹터를 제외한 대표지수 변형 ETF이므로 `Broad Market/Nasdaq-100/Ex Technology`로 분류한다. |

***
## 1. 기본 정보
| 항목 | 내용 |
|------|------|
| **정식 명칭** | First Trust NASDAQ-100 Ex-Technology Sector Index Fund |
| **티커** | QQXT (NASDAQ 상장) |
| **설정일** | 2007년 2월 8일[4][5] |
| **운용 기간** | 약 19년 |
| **운용사** | First Trust Advisors L.P.[6] |
| **상장 거래소** | NASDAQ[2] |
| **추종 지수** | NASDAQ-100 Ex-Tech Sector Index (NXTR)[6] |
| **지수 가중 방식** | Equal-weighted (동일가중)[2] |
| **순자산 규모(AUM)** | 약 $200M ~ $239M[4][2] |
| **시가총액** | $1.11B​ |
| **현재가** | $100.65​ (2026.03.11 기준) |
| **52주 범위** | $83.08​ ~ $104.06​ |
| **총 보유 종목 수** | 56​개 |
| **펀드 매니저** | Roger Testin, Daniel Lindquist, Jon Erickson 외[5] |
...
| 항목 | 내용 |
|------|------|
| **총 보수율 (Gross Expense Ratio)** | 0.61%[6] |
| **순 보수율 (Net Expense Ratio)** | 0.60%[6][1] |
| **비용 상한 (Cap)** | 연 0.60% (계약 기반)[6] |
| **포트폴리오 회전율** | 높음 (분기별 리밸런싱에 따른 결과)[7] |
### 경쟁 ETF 대비 비용 비교
QQXT의 0.60% 비용비율은 동일 전략 카테고리 내에서 상대적으로 **높은 편**에 해당한다. 직접적 경쟁 ETF인 ProShares S&P 500 Ex-Technology ETF(SPXT)의 비용비율은 0.09%에 불과하여 QQXT 대비 약 6.7배 저렴하다. Vanguard Growth ETF(VUG)는 0.04%, Invesco QQQ(QQQ)는 0.20%로 운용된다.[9][10][11]

| ETF | 추종 지수 | 비용비율 | AUM |
|-----|-----------|----------|-----|
| **QQXT** | NASDAQ-100 Ex-Tech Sector | 0.60%[6] | ~$200M+ |
| **SPXT** | S&P 500 Ex-Information Technology | 0.09%[11] | — |
| **QQQ** | NASDAQ-100 | 0.20%[9] | $391B+ |
| **VUG** | CRSP US Large Cap Growth | 0.04%[9] | $195B+ |
...
| 항목 | 수치 |
|------|------|
| **일평균 거래량 (최근 3개월)** | 241,731​주 |
| **평균 거래량 (장기)** | 17,333​주 |
| **일평균 거래대금 (최근 3개월)** | $21,849,183​ |
...
|------|------|
| **표준편차 (3년 연환산)** | 16.55%​ |
| **표준편차 (3년, 별도 소스)** | 13.55%[14] |
| **샤프 비율 (3년)** | 0.43​ |
| **샤프 비율 (별도 소스)** | 0.43 ~ 0.78[16][17] |
| **최대 낙폭 (2020~)** | -25.05%​ |
| **최대 낙폭 (설정 이래)** | -57.45%[18][19][17] |
| **베타** | 0.90[14][2] |
| **P/E 비율** | 23.66​ |
...
| 항목 | 내용 |
|------|------|
| **배당 수익률 (TTM)** | 약 0.71% ~ 1.20%[21][4] |
| **연간 배당금 (TTM)** | $0.71 ~ $1.20[21][2] |
| **배당 지급 주기** | 분기별 (Quarterly)[21] |
| **배당성향 (Payout Ratio)** | 15.48%[2] |
| **1년 배당 성장률** | -36.33%[21] |
### 최근 배당 이력
| 배당락일 | 배당금 | 지급일 |
|----------|--------|--------|
...
## 8. 리스크 요소
### 베타 계수 및 시장 민감도
QQXT의 베타는 **0.90**으로, S&P 500 대비 시장 전체 움직임에 대한 민감도가 약간 낮은 수준이다. 기술 섹터를 제외했기 때문에 기술주 급등·급락 시 QQQ(베타 약 1.0 이상) 대비 변동성이 낮게 나타난다.[14][2]
