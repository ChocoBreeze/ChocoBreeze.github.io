---
title: 'SEMI (iShares MSCI Global Semiconductors UCITS ETF)'
...
| 항목 | 내용 |
| :-- | :-- |
| **펀드명** | iShares MSCI Global Semiconductors UCITS ETF USD (Acc) |
| **티커** | SEMI (다중 상장: SEMI/LSE, SEME/Borsa Italiana, SEC0/Xetra, SEMI/Euronext) |
| **ISIN** | IE000I8KRLL9 |
| **거래소** | LSE, Euronext Amsterdam, Xetra, Borsa Italiana, Euronext Paris |
| **출범일** | 2021년 8월 5일 (4.4년 운영) |
| **현재 가격** | €10.94 (2025년 12월 말) |
| **자산규모** | €1,521M (약 \$1.65B USD) |
| **보유 종목** | 30-50+ (광범위) |
| **연간 수수료** | 0.35% |
| **배당 정책** | 누적(Accumulating) - 배당금 없음 |
| **지수** | MSCI Global Semiconductors Index |
| **펀드 설립지** | 아일랜드 |

SEMI는 CHPX(신규 3.5개월), PSI(20.6년), FTXL(9.3년)의 중간 수준의 운영 기간을 갖춘 상대적으로 신규 펀드이다. 중요한 특징은 **글로벌 범위**로, SMH/SOXX처럼 미국 중심이 아니라 TSMC, ASML, SK Hynix 등 국제 기업까지 포함한다.
...
| **1-Year (2025)** | +53.46% |
| **3-Year (연)** | +42.05% |
| **5-Year** | N/A (4.4년 이상 미달) |
| **Since Inception (연)** | +19.37% |
...
| **SMH** | 55% | 35.9% | 14년 |
| **SOXX** | 52% | 25.4% | 18년 |
| **SEMI** | 53.46% | 42.05% | 4.4년 |
| **FTXL** | 49% | 11.6% | 9.3년 |
| **PSI** | 36.31% | 18.02% | 20.6년 |

![SEMI와 주요 반도체 ETF 종합 지표 비교](images/image.png)
...
- 3년 기준 **42.05%로 SMH(35.9%)를 6.15pp 상회** → SEMI의 가장 큰 성과 강점
- SOXX(25.4%), FTXL(11.6%), PSI(18.02%) 모두 능가

SEMI는 단기간 운영했지만 **가장 강력한 3년 누적 성과**를 기록했다는 점이 핵심 강점이다.

### 성과 우수의 원인

1. **글로벌 포트폴리오**: TSMC(7.51%), ASML(8.18%) 직접 노출로 2023-2025 AI/수익성 호황 수혜
2. **MSCI 가중 방식**: 시가총액 가중으로 NVIDIA(6.41%)과 TSMC의 높은 수익성 포착
3. **부정확한 시장 진입**: 2021년 8월 출범 시점이 AI 붐 초기 (절호의 기회)
4. **다각화 이점**: 미국+국제 중소형주 포함으로 다각화된 성장 동력

***

## 3. 포트폴리오 구성 분석

**상위 10대 종목** (Dec 31, 2025 FT 데이터)
...
SEMI는 **광범위하고 균형 잡힌 포트폴리오**를 특징으로 한다:
...
![SEMI와 SMH 및 SOXX 지역별 노출 비교](images/image-1.png)

Geographic Exposure: SEMI vs SMH vs SOXX

### 국가별 노출도 (추정)

- **미국**: 47.5% (NVIDIA, Broadcom, Micron, Intel 등)
- **대만**: 17.5% (TSMC, MediaTek)
- **네덜란드**: 10% (ASML)
- **기타 국제**: ~25% (일본, 싱가포르, 남한, 기타 선진국)

**핵심 특징**: SEMI는 **글로벌 범위**로 국제 기업을 직접 포함한다. SMH/SOXX는 미국 중심이지만 SEMI는 진정한 글로벌 분산.
...
| :-- | :-- | :-- | :-- | :-- | :-- |
| **TER** | 0.35% | 0.35% | 0.34% | 0.60% | 0.56% |
| **우위** | ✓ 최저 경쟁 | ✓ 동등 | 최저 | × 높음 | × 높음 |

SEMI는 **0.35% 최저 수수료** 수준으로 SMH와 동등하고 SOXX에 거의 같다. FTXL(0.60%), PSI(0.56%)보다 훨씬 우수하다.

**배당 정책**

- **배당 분배**: 없음 (누적 자동 재투자)
- **배당 수익률**: 0%
- **특징**: 배당 추구 투자자에게 부적합, 성장 추구 투자자에게 적합
...
| :-- | :-- |
| **AUM** | €1,521M (\$1.65B) - 충분 |
| **거래 유동성** | 우수 (iShares, 다중 상장) |
| **Bid-Ask 스프레드** | 합리적 (보통 tight) |
| **거래소** | LSE, Amsterdam, Xetra 등 다중 |
...
**핵심 특징**: 글로벌 범위, 시가총액 가중

**선별 기준**

1. **산업 분류**: GICS 반도체 분류의 모든 기업
2. **글로벌 범위**: 미국, 국제 모두 포함 (ADR 제약 없음)
3. **포함 분야**:
    - 반도체 설계 (fabless)
    - 제조 (파운드리, IDM)
    - 장비 및 소재
...
| **자산규모** | \$1.65B | \$43.5B |
| **수수료** | 0.35% | 0.35% |
| **지역 범위** | 글로벌 | US 중심 + TSMC/ASML |
| **NVIDIA 비중** | 6.41% | 20%+ |
| **TSMC 비중** | 7.51% (직접) | 14%+ (ADR) |
| **상위 5 비중** | 34.30% | 45-50% |
| **1년 수익률** | 53.46% | 55% |
| **3년 수익률** | 42.05% | 35.9% |
| **설립** | 4.4년 | 14년 |
| **우위** | 글로벌, 높은 3년 수익 | 대형, NVIDIA 베팅, 역사 |

**결론**: SMH가 규모와 역사에서 우위이지만, SEMI는 **3년 성과(42% vs 36%)와 글로벌 분산**에서 우수하다. 신규 투자자에게는 SEMI, 기존 포트폴리오 추가에는 SMH.
...
| **자산규모** | \$1.65B | \$19.9B |
| **수수료** | 0.35% | 0.34% |
| **지역 범위** | 글로벌 | US-only (ADRs) |
| **집중도** | 낮음 (상위5=34%) | 높음 (상위10=60%+) |
| **1년 수익률** | 53.46% | 52% |
| **3년 수익률** | 42.05% | 25.4% |
| **특징** | 글로벌 분산 | US 집중 |

**결론**: SEMI가 명백히 우수. 비용은 동등(0.35% vs 0.34%), 수익률은 SEMI 대폭 앞서감(3년 42% vs 25%).
...
| **1년 수익률** | 53.46% | 49% |
| **3년 수익률** | 42.05% | 11.6% |
| **구성 방식** | MSCI 시가총액 | 팩터 가중 |

**결론**: SEMI가 압도적 우수. 수수료 차이(0.35% vs 0.60%)와 성과 차이(3년 42% vs 11.6%) 모두.
...
- **설립**: 2021년 8월 (4.4년)
- **단점**: SMH(14년), SOXX(18년), PSI(20년)보다 훨씬 짧은 운영 기간
- **장점**: 출범이 2021년 AI 붐 초기로 절호의 타이밍
- **평가**: 중간 수준 (장기 실적 미검증)


### 2. EUR 환율 위험 ★★

- **펀드 통화**: EUR 기반 (USD 환산 노출)
- **위험**: 달러 강세 시 손실
    - 예. EUR/USD 10% 약세 → USD 투자자 10% 손실
- **헤지 옵션**: SEC0 (EUR hedged) 있으나 별도 수수료
- **2025 환율**: 달러 강세로 EUR 약세 영향


### 3. 국제 시장 위험 ★★

- **대만 노출**: 17.5% (TSMC 7.51%, 기타 10%)
    - 대만 해협 긴장 시 큰 영향
- **네덜란드**: ASML 8.18% (미중 기술 전쟁 규제 위험)
- **이머징 마켓**: 싱가포르 등 소수 이머징 시장 포함 가능


### 4. 글로벌 공급망 리스크 ★★

- **지정학**: 미국-중국-대만-네덜란드 연쇄 관계
- **규제**: 반도체 기술 수출 규제 강화 가능성
- **환율**: 다국적 통화 노출


### 5. 팩터 집중도 리스크 ★

- **MSCI 가중**: 시가총액 기반이므로 NVIDIA 같은 대형주에 의존
- **AI 사이클**: AI 투자 둔화 시 동시 하락 위험
- **평가**: 상대적으로 낮음 (SEMI 상위 5=34% vs SMH 45-50%)


### 6. 배당 제로 리스크 ★

- **배당 없음**: 수익 추구 투자자에게 부적합
- **세금 효율**: 한편 누적식이 세금 효율적 (한국 투자자는 분배 시 과세)


### 7. 추적 오차 위험 ★

- **성능**: 2024/2025 추적 오차 <0.5% (우수)
- **평가**: 우려 없음


### 8. 금리 민감성 위험 ★★

- **무배당 고성장**: 금리 상승 환경에서 취약
- **2024-2025**: 저금리 환경에서 이득 봤으나, 2026 금리 정상화 시 조정 우려
...
- **해외 거래소 상장**: LSE(GBP), Euronext(EUR/USD), Xetra(EUR) 등
- **한국 증권사**: 국제 거래 가능 (직접 매입 어려울 수 있음)
- **환율 위험**: EUR 노출 추가 고려
- **세금**: 배당금/자본이득 한유 이중 과세
...
| 상품 | 장점 | 단점 |
| :-- | :-- | :-- |
| **SEMI 직접 구매** | 글로벌, 3년 성과 우수 | EUR 환율 위험, 거래 복잡 |
| **SMH 직접 구매** | NASDAQ 상장, 많은 정보 | 미국 집중, 낮은 성과 |
| **국내 반도체 ETF** | 원화거래, 높은 유동성 | 0.70-0.80% 고수수료 |
| **국내 글로벌 펀드** | 액티브 관리, 환율 헤지 | 1.0-1.5% 극히 높은 수수료 |

**권고**: 글로벌 분산 선호 시 SEMI, 미국 중심 선호 시 SMH. 원화거래 원시 국내 반도체 ETF.
...
| 항목 | 점수 | 코멘트 |
| :-- | :-- | :-- |
| **수익 잠재력** | 8/10 | 글로벌 반도체 성장성 우수, 3년 42% 성과 |
| **비용 효율** | 9/10 | 0.35% 최저 경쟁 수준 |
| **포트폴리오 품질** | 8/10 | 균형 잡힌 글로벌 포트폴리오, 집중도 낮음 |
| **유동성** | 7/10 | €1.5B 충분, BlackRock 배포망 |
| **위험 관리** | 7/10 | EUR 환율, 대만 지정학 위험 |
| **혁신성** | 8/10 | 글로벌 범위 차별화, MSCI 신뢰 |
| **안정성** | 7/10 | 4.4년 상대적 신규, BlackRock 신뢰도 |
| **성과 vs 경쟁** | 8/10 | 3년 42% (SMH 35.9% 능가), 1년 53% |
...
- **권고**: **중립(Hold SMH)** → **소액 SEMI 고려** (전체의 20-30%)
- **이유**: SMH 이미 충분한 노출, SEMI로 국제 분산 추가


#### 3. SOXX 보유 투자자

- **권고**: **SEMI로 스위치 검토** (성과 차이 16.6pp)
- **이유**: SEMI의 압도적 3년 성과 (42% vs 25.4%)
...
- **권고**: **최우선 선택**
- **이유**: 글로벌 분산 + EUR 노출 = 통화 다각화


#### 거래 전략

1. **점진적 매입**: 초기 매입 후 3-4개월에 걸쳐 분할 매입
2. **환율 타이밍**: EUR 약세 시 매입 (2025년 달러 강세 고려)
3. **비중**: 반도체 노출의 60-70% (나머지 SMH 또는 국내 반도체 ETF)
4. **보유 기간**: 5년 이상 (글로벌 반도체 사이클 경험)

***

## 12. 결론

SEMI는 **글로벌 반도체 노출을 원하는 투자자의 최고 선택지**이다. 4.4년의 상대적 신규 펀드임에도 불구하고 **3년 기준 42.05%의 뛰어난 성과**로 SMH/SOXX를 능가했다. 0.35% 최저 수수료와 TSMC/ASML을 직접 포함한 글로벌 포트폴리오는 차별화된 강점이다.

**강점**: 글로벌 분산, 3년 최고 성과(42%), 최저 수수료(0.35%), MSCI/BlackRock 신뢰

**약점**: 신규 펀드(4.4년), EUR 환율 위험, 배당 제로, 국제 규제 리스크

**최종 권고**:

- **글로벌 반도체 노출 원하는 투자자**: 강력 추천
- **SMH 보유자**: 국제 분산 추가로 20-30% 고려
- **SOXX 보유자**: 스위치 검토 (성과 차이 16.6pp)
- **국내 투자자**: 거래 가능성 확인 후 진입
