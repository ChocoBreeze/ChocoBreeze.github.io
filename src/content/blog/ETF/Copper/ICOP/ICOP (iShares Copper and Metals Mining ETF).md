...
ICOP(iShares Copper and Metals Mining ETF)는 2023년 6월 21일부터 운영 중인 **광범위 구리 및 금속 광산 회사 전문 ETF**다. 현재 순자산 \$264-276M, 보수료 **0.47%(최저)**, 41개 종목 보유로 **구리에서 금, 은, 니켈까지 광범위한 광산 노출**을 제공한다.

ICOP는 **"최신 이쉐어즈 기술과 최저 비용으로 광범위 광산 메가트렌드를 캡처하는 차세대 선택"** 이다:

**강렬한 우월성**:

- 1년 수익: **77.87%** (COPX 66.76% 대비 **+11.1% 우월**)
- 보수료: **0.47%** (COPX 0.65% 대비 **28% 저렴**)
- 최대 낙폭: **-38.67%** (COPX -83.16% 대비 **훨씬 안전**)
- 배당 수익: **2.40%** (COPX 1.23% 대비 2배)
- 금속 다각화: **구리 45% + 금 25% + 다타** (불황 헤지)
...
**현 시점 평가**: ICOP는 **"차세대 핵심 광산 ETF이자 비용 최소화 투자자의 최우선 선택"** 이다. COPX가 점진적으로 구식화될 가능성이 높다.
...
| 항목 | 내용 |
| :-- | :-- |
| **공식명칭** | iShares Copper and Metals Mining ETF |
| **운용사** | iShares (BlackRock) |
| **티커** | ICOP |
| **상장일** | 2023년 6월 21일 (2.5년) |
| **순자산(AUM)** | 약 2.6-2.76억 달러 (빠르게 성장) |
| **보수율** | **0.47%** (모든 광산 ETF 최저) |
| **펀드 구조** | 전통 ETF |
| **세금 형식** | 1099 (간단) |
| **분배 주기** | 반연간 (매년 2회) |
| **재조정** | 정기 (최적 시점) |
| **기초지수** | STOXX Global Copper and Metals Mining Index (Net TR) |

### 광범위 금속 광산 전략의 비전

ICOP는 **광범위한 금속 광산 노출**을 추구한다:
...
ICOP의 성과는 **신설 펀드가 기성 펀드를 이기는 극히 드문 경우**를 보여준다:


| 기간 | ICOP | COPX | COPP | COPJ | 차이 |
| :-- | :-- | :-- | :-- | :-- | :-- |
| **1년** | 77.87% | 66.76% | 72.19% | 137.4% | ICOP +11.1% |
| **2.5년 CAGR** | 28.44% | N/A | N/A | N/A | 탁월함 |
| **최대 낙폭** | -38.67% | -83.16% | -50% | -60%+ | ICOP 훨씬 안전 |
...
| 항목 | ICOP | COPX |
| :-- | :-- | :-- |
| **출시** | Jun 2023 (2.5yr) | Apr 2010 (16yr) |
| **1년 수익** | 77.87% | 66.76% |
| **역사** | 미검증 | 완전 검증 |
| **보수료** | 0.47% (저렴) | 0.65% (표준) |
| **최대 낙폭** | -38.67% (안전) | -83.16% (격렬) |
| **금속** | 구리/금/다타 | 순수 구리 |
| **배당** | 2.40% | 1.23% |
| **AUM** | \$276M | \$5.83B |
| **투명성** | 신규 | 완성 |
...
ICOP는 **"차세대 광산 ETF의 왕이자 비용 최소화 시대의 상징"** 이다.
...
**"ICOP는 COPX의 후계자이자 미래 표준이 될 가능성이 높다. 비용 우위(0.47%)가 30년 동안 \$30K+ 추가 수익을 생성할 것이고, 2025년 금 노출 보너스(+11%)는 광범위 금속 전략의 가치를 입증했다."**

**COPX vs ICOP 선택**:

- **젊은 투자자** (30-40): ICOP (비용 우위 중요)
- **중년 투자자** (50-60): ICOP (역사 충분, 비용 중요)
- **보수 투자자** (60+): COPX (16년 역사 평안)
