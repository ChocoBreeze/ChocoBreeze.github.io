---
title: 'SPY (SPDR S&P 500 ETF Trust) 종합 분석 보고서'
...
**분석 기준일**: 2026년 1월 31일
**티커**: SPY | **상장거래소**: NYSE Arca | **운용사**: State Street Global Advisors
...
0.0645%p의 보수 차이가 30년 후 약 **\$10,000 (원금 대비 100%)**의 차이를 만든다. 이는 복리 효과의 강력함을 보여주는 동시에, 장기 투자자에게 SPY가 비효율적임을 시사한다.[^5][^6][^13]
...
이를 합산하면 SPY의 **실질 비용은 약 0.15~0.20%**로, 공식 보수 대비 50~100% 높다.[^13]
...
SPY vs VOO 논쟁은 본질적으로 **"유동성 프리미엄 vs 비용 효율성"**의 대결이다.
...
SPY는 완벽한 ETF가 아니다. 높은 보수, UIT 제약, cash drag는 명백한 약점이다. 그러나 **"완벽함보다 적합함"**이 중요하다.
