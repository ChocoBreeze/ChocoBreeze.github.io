...
![URNM과 URA NLR S&P 500 성과 비교](images/image.png)

URNM vs URA, NLR and S\&P 500 Performance Comparison (2025-2023)

**성과 하이라이트:**

- **YTD 2025 (NAV)**: 40.44%[^1]
- **1년 수익률**: 40.44%[^1]
- **3년 연평균**: 24.03%[^1]
- **5년 연평균**: 24.92%[^1]
- **설정 이후(12/2019)**: 31.57% 누적(연평균 기준에서 계산)[^1]
...
**분석**: 우라늄 가격이 2025년 견조했음에도 우라늄 채광사들이 약한 이유는:

1. **개발 일정 지연**: 많은 우라늄 광산 프로젝트가 규제/환경 승인 지연[^5]
2. **유틸리티 수요 부족**: 2025년 유틸리티들의 우라늄 수매가 예상 대비 훨씬 적음[^5]
3. **기업 실사**: 기금이 대형주(Cameco 20.51%) 중심이라 개발 단계 소형 광산보다 느린 수익 성장[^5]
...
![URNM 상위 10개 보유 종목 구성](images/image-1.png)

URNM Top 10 Holdings Portfolio Composition

URNM의 상위 10개 종목이 전체 자산의 약 79%를 차지하는 **높은 집중도**를 보입니다.[^1][^2]

**상위 10개 보유 종목 (2025년 12월 31일):**
...
- **상위 3개**: Cameco + Kazatomprom + Sprott Trust = 47.39% (극도의 집중)[^1]
- **상위 5개**: 70.47% (매우 높음)[^1]
...
![URNM 시가총액별 포트폴리오 구성](images/image-2.png)

URNM Market Cap Composition

URNM은 균형 잡힌 시장 규모 분산을 제공합니다.

- **대형주 (>\$10B)**: 24.59% (Cameco, Kazatomprom 등)[^1]
- **중형주 (\$2-10B)**: 34.71% (가장 큰 세그먼트)[^1]
- **소형주 (<\$2B)**: 26.82%[^1]
- **미분류**: 13.88%[^1]
- **평균 회사 시가총액**: \$10,357.97M[^1]
...
- **2024년 12월**: \$1.2782 (12월 12일 배당락)[^6]
- **2023년 12월**: \$1.751 (12월 15일)[^6]
- **2023년 이전**: 추가 데이터 부족

**현재 배당수익률**: 2.11-2.90%[^1][^6]
...
- **PER**: 7.69 (매우 낮음, 채광 회사의 사이클적 특성 반영)[^2][^7]
- **배당 성장**: -36.99% YoY (감소 추세)[^6]
...
- **베타**: 0.8-0.9 (시장 평균보다 낮음)[^8]
- **월간 표준편차**: 8.03% (매우 낮음)[^6][^8]
- **최대 낙폭**: -50.78% (URA의 -93.54%보다 훨씬 나음)[^9][^8]
- **URA와 상관계수**: 0.48 (중간 정도, 다각화 효과 제공)[^8]
- **52주 범위**: 추정 \$45-78.50 (약 74% 범위)
...
1. **포트폴리오 집중도**: 상위 3개 47.39% (극도의 집중)[^1]
2. **대형주 의존성**: Cameco 20.51%, Kazatomprom 13.22%에 크게 의존[^1]
3. **개발 지연 위험**: 2024년 -14.07% 손실은 프로젝트 지연 시사[^3]
4. **우라늄 가격 하락 위험**: 직접 연동으로 40-50% 낙폭 가능[^5]
5. **정책 리스크**: 카자흐스탄(13.22%) 정치/규제 위험[^10]
6. **유틸리티 수요 부족**: 2025년 유틸리티 구매 약함이 2024 약세 일부 원인[^5]
...
- **평균 일일 거래량**: 608,764-675,483 주[^12]
- **평균 일일 거래액**: \$40-45 million (현재 가격 기준)[^1]
- **매수호가-매도호가 스프레드**: 0.22% (매우 좁음)[^4][^1]
- **유동성 등급**: A (우수)
- **회전율**: 추정 2-3%
...
| 지표 | 수치 | 평가 |
| :-- | :-- | :-- |
| **1년 펀드 유입** | +\$99.59-166.31M | 양수 (좋음) |
| **vs URA 유입** | URA +\$2.24B | URNM은 URNM 1/22 수준 |
| **vs NLR 유입** | NLR +\$2.44B | URNM은 1/24 수준 |
| **NAV 프리미엄** | 0.2-0.74% | 약간의 프리미엄 (수요 양호) |

**분석**: 양수 펀드 유입은 긍정적이지만, 절대적으로는 대형 ETF들에 비해 크게 작습니다.[^13][^6]
...
1. **적체된 수요 해소**: 유틸리티들의 지연된 우라늄 구매가 2026년 쏟아질 것으로 기대[^5]
2. **호가 가격 상승 시작**: 12월 말 호가 가격이 상승 시작, 이는 유틸리티들이 더 높은 가격 수용 시작을 의미[^5]
3. **광산 개발 진전**: Q1 2026에 주요 광산들의 환경 허가 승인 예상[^5]
4. **광산 공급 규율**: 생산자들이 저가 판매 거절, 공급 규율 유지[^5]
...
| 차원 | URNM | URA | 판정 |
| :-- | :-- | :-- | :-- |
| **순자산** | \$2.18B | \$5.40B | URA (2.5배 더 큼) |
| **보유 종목** | 26-35개 | 49-51개 | URA (더 분산) |
| **상위 3개 비중** | 47.39% | ~40% | URNM (더 집중) |
| **Cameco 비중** | 20.51% | 23.37% | URA (약간 높음) |
| **물리 우라늄** | 13.66% | 있음 | 유사 |
| **거래 스프레드** | 0.22% | 0.07% | URA (훨씬 좁음) |
| **배당수익률** | 2.90% | 1.48% | URNM (높음) |
| **운용수수료** | 0.75% | 0.69% | URA (저렴) |
| **2025 성과** | 40.44% | 67.41% | URA (+27 포인트) |
| **2024 성과** | -14.07% | 데이터 부족 | 비교 불가 |
| **최대 낙폭** | -50.78% | -93.54% | URNM (낮음) |
...
| 차원 | URNM | URNJ | 판정 |
| :-- | :-- | :-- | :-- |
| **시장 규모** | 대형+중형 | 중형+소형만 | URNM (안정성) |
| **Cameco 비중** | 20.51% | 0% (상위 10외) | URNM |
| **순자산** | \$2.18B | \$437.62M | URNM (5배) |
| **배당** | 2.90% | 5.61% | URNJ (극도로 높음) |
| **변동성** | 8.03% | 44-58% | URNM (훨씬 낮음) |
| **운용수수료** | 0.75% | 0.80% | URNM |
| **2025 성과** | 40.44% | 44.76% | URNJ (+4.32%) |
...
| 차원 | URNM | NLR | 판정 |
| :-- | :-- | :-- | :-- |
| **전략** | 광산사 중심 | 균형 (광산+유틸리티+서비스) | 다름 |
| **배당** | 2.90% | 0.42% | URNM |
| **변동성** | 8.03% | ~37-40% | URNM (훨씬 낮음) |
| **2025 성과** | 40.44% | 55.9% | NLR (+15.46) |
| **비용** | 0.75% | 0.56% | NLR |
| **순자산** | \$2.18B | \$4.47B | NLR (더 큼) |

**차이점**: URNM은 순수 광산사, NLR은 원자력 산업 전반
...
URNM은 **우라늄 광산사 직결 플레이를 원하는 투자자용** 상품입니다.[^11]
...
URNM은 **중도적 태도의 우라늄 플레이**로 고려할 수 있습니다:

**분할 진입 권장:**

1. **1차 (현재, \$68)**: 포트폴리오의 2-3% 진입
2. **2차 (조정시, \$60-62)**: 추가 2-3% 진입
3. **최대 포지션**: 포트폴리오의 5-8%

**청산 전략:**

- **이익 실현**: \$85-90 도달 시 절반 청산
- **손실 한계**: \$55 하락 시 절반 청산
...
| :-- | :-- | :-- | :-- | :-- |
| **약세** (수요 부족/규제) | 15% | \$70-80/lb | \$55-62 | -9~-10% |
| **중도** (현상유지) | 50% | \$85-100/lb | \$68-80 | 0~+18% |
| **강세** (공급 제약/수요 증가) | 30% | \$110-130/lb | \$85-105 | +25~+54% |
| **극강세** (정책/개발 가속화) | 5% | \$150+/lb | \$110+ | +62%+ |
| **기대값** | - | ~\$100/lb | **\$72-82** | **+8~+21%** |
...
URNM은 2026년 우라늄 산업의 호전 기대를 배경으로 **선택적 매수 기회**를 제시합니다.[^1][^5]
...
**"선택적 매수 - 우라늄 광산사 확신 있는 투자자만"**

**조건부 매수:**

- **적극 권장**: \$60-65 범위에서 진입
- **중도 권장**: 현재 \$68 수준에서 소량 (1-2%)
- **보류**: \$75 이상에서는 진입 삼가
...
**출처**: Sprott 공식, Yahoo Finance, TradingView, ETF Database, Schwab, StockAnalysis 등 공식 재무 데이터
