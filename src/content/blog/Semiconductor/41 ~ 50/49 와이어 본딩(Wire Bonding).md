...
> <strong>와이어 본딩은 아주 얇은 금속 실(금/구리 등)로 칩과 패키지를 전기적으로 연결하는 방법이야.</strong>
...
다이를 “작은 집”이라고 하면,  
와이어 본딩은 집에서 밖으로 나가는 <strong>전깃줄</strong>을 하나하나 연결하는 느낌이야.
...
진짜로 <strong>얇은 실들이 거미줄처럼</strong> 보이는 경우가 많아.
