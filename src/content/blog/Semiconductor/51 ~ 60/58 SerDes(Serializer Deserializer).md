...
> **SerDes는 많은 데이터를 한 줄로 빠르게 보내고, 받은 쪽에서 다시 여러 줄 데이터로 풀어주는 장치야.**

---

## 2) 비유

큰 상자 여러 개를 한 번에 옮기기 어렵다면, 그 안의 물건을 **한 줄로 길게 정리해서** 좁은 문으로 통과시키고, 반대편에서 다시 **원래대로 펼치는 것**을 떠올리면 돼.

즉,

* 보내기 전: 여러 줄 데이터를 **한 줄로 압축해서 보냄**
* 받은 후: 다시 **여러 줄로 펼쳐서 사용**
...
즉, **많은 차선을 하나의 초고속 터널로 보내고, 반대편에서 다시 차선을 나누는 느낌**이야.
